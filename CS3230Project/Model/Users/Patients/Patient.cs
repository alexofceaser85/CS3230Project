...
namespace CS3230Project.Model.Users.Patients
{
    ...
    public class Patient
    {
        ...
        public Patient(int patientId, string firstName, string lastName, DateTime dateOfBirth, string gender,
            ...
            bool status)
        {
            if (patientId < 0) throw new ArgumentException(PatientErrorMessages.PatientIdCannotBeLessThanZero);
            if (firstName == null) throw new ArgumentException(PatientErrorMessages.FirstNameCannotBeNull);
            if (firstName.Trim().Length == 0) throw new ArgumentException(PatientErrorMessages.FirstNameCannotBeEmpty);
            if (lastName == null) throw new ArgumentException(PatientErrorMessages.LastNameCannotBeNull);
            if (lastName.Trim().Length == 0) throw new ArgumentException(PatientErrorMessages.LastNameCannotBeEmpty);
            ...
            if (gender == null) throw new ArgumentException(PatientErrorMessages.GenderCannotBeNull);
            if (gender.Trim().Length == 0) throw new ArgumentException(PatientErrorMessages.GenderCannotBeEmpty);
            if (addressOne == null) throw new ArgumentException(PatientErrorMessages.AddressOneCannotBeNull);
            if (addressOne.Trim().Length == 0)
                throw new ArgumentException(PatientErrorMessages.AddressOneCannotBeEmpty);
            if (city == null) throw new ArgumentException(PatientErrorMessages.CityCannotBeNull);
            if (city.Trim().Length == 0) throw new ArgumentException(PatientErrorMessages.CityCannotBeEmpty);
            if (state == null) throw new ArgumentException(PatientErrorMessages.StateCannotBeNull);
            if (state.Trim().Length == 0) throw new ArgumentException(PatientErrorMessages.StateCannotBeEmpty);
            if (zipcode == null) throw new ArgumentException(PatientErrorMessages.ZipcodeCannotBeNull);
            if (zipcode.Trim().Length == 0) throw new ArgumentException(PatientErrorMessages.ZipcodeCannotBeEmpty);
            if (phoneNumber == null) throw new ArgumentException(PatientErrorMessages.PhoneNumberCannotBeNull);
